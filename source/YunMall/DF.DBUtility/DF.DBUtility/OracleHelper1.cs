/// <summary>
/// 程序说明：Oracle数据库操作公共类,静态方法调用,暂未启用
/// 各部分之间的关系及本文件与其它文件关系等。   实现数据的逻辑操作
/// 建立者：王龙
/// 建立日期：2015年12月28日。
/// 修改记录：将每个方法的ConnectionString提出
/// 修改者：：修改日期时间：
/// 修改内容：说明该次修改的程序内容。
/// </summary>
using System;
...
namespace DF.DBUtility
{
    ...
    public abstract class OracleHelper1
    {
        ...
        public static readonly string ConnectionString = ConfigurationManager.AppSettings["SysConnStr"];
